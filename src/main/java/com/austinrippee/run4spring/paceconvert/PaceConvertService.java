...
public class PaceConvertService {
    ...
    private double computeScore(String distance, double t) {
        return switch (distance) {
            ...
            case "1 Mile", "1Mile", "Mile", "One Mile", "1609", "1609m",
                 "1 mile", "1mile", "1mi", "mile", "one mile", "One mile", "one Mile" ->
            ...
            case "2 Mile", "2 Miles", "2Mile", "2Miles", "Two Miles", "Two Mile",
                 "3218", "3218m", "2mi", "2MI", "2Mi" ->
    ...
    private String computeConvertedTime(String target, double score) {
        double totalSecs = switch (target) {
